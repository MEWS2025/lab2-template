...
- [src/ceml.langium](src/ceml.langium) -  The grammar definition of your language
- [src/ceml-module.ts](src/ceml-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/ceml-validator.ts](src/ceml-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/ceml.monarch.ts](src/syntaxes/ceml.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/ceml.tmLanguage.json](syntaxes/ceml.tmLanguage.json) - Textmate based syntax highlighting instructions.
